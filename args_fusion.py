class args():
    ...
    dataset_ir = "./m3fd/data/ir_new"
    dataset_vis = "./m3fd/data/vis_new"
    ...
    resume_G =None#'./models/ligth/Final_epoch_G16_Fri_Mar_14_01_52_26_2025_.model'
    ...
    model_default = 'Finally_model.model'
